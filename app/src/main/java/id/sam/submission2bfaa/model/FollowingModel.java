...
public class FollowingModel implements Serializable, Parcelable
{
    ...
    public final static Creator<FollowingModel> CREATOR = new Creator<FollowingModel>() {
    ...
    ;
    private final static long serialVersionUID = -4302954052429016643L;
     ...
     * @param nodeId
     */
    public FollowingModel(String login, Integer id, String nodeId, String avatarUrl, String gravatarId, String url, String htmlUrl, String followersUrl, String followingUrl, String gistsUrl, String starredUrl, String subscriptionsUrl, String organizationsUrl, String reposUrl, String eventsUrl, String receivedEventsUrl, String type, Boolean siteAdmin) {
        super();
        this.login = login;
        this.id = id;
        this.nodeId = nodeId;
