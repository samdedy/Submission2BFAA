...
public class Item implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = -480750754935573099L;
     ...
     * @param nodeId
     */
    public Item(String login, Integer id, String nodeId, String avatarUrl, String gravatarId, String url, String htmlUrl, String followersUrl, String followingUrl, String gistsUrl, String starredUrl, String subscriptionsUrl, String organizationsUrl, String reposUrl, String eventsUrl, String receivedEventsUrl, String type, Boolean siteAdmin, Double score) {
        super();
        this.login = login;
        this.id = id;
        this.nodeId = nodeId;
