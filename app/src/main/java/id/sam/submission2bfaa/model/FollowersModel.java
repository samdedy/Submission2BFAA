...
public class FollowersModel implements Serializable, Parcelable
{
    ...
    public final static Creator<FollowersModel> CREATOR = new Creator<FollowersModel>() {
    ...
    ;
    private final static long serialVersionUID = -4774376836762263632L;
     ...
     * @param nodeId
     */
    public FollowersModel(String login, Integer id, String nodeId, String avatarUrl, String gravatarId, String url, String htmlUrl, String followersUrl, String followingUrl, String gistsUrl, String starredUrl, String subscriptionsUrl, String organizationsUrl, String reposUrl, String eventsUrl, String receivedEventsUrl, String type, Boolean siteAdmin) {
        super();
        this.login = login;
        this.id = id;
        this.nodeId = nodeId;
